...
- `point-amaranth-app.jsx` — o aplicativo completo (React, arquivo único)
...
- **Proficiências** (33), em 4 categorias: Combate, Física, Social, Mental
...
O arquivo é um componente React único. Pode ser usado em qualquer projeto React/Vite, ou visualizado pelo link do Lovable acima.
